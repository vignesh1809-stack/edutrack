...
const StudentDashboard = () => {
    ...
    return (
        <div className="bg-surface text-on-surface antialiased pb-24 md:pb-8 font-body min-h-screen" style={{ minHeight: 'max(884px, 100dvh)' }}>
            {/* TopAppBar */}
            <header className="sticky top-0 w-full z-50 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.03)] flex items-center justify-between px-6 py-4">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-primary-container md:border-0">
            ...
            <main className="px-6 w-full max-w-7xl mx-auto space-y-8 pt-8 md:pt-12">
                {/* Welcome Header */}
            ...
            <nav className="fixed bottom-0 left-0 w-full flex justify-around items-center px-4 pb-6 pt-3 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-t border-slate-100 dark:border-slate-800 shadow-[0_-10px_40px_rgba(42,52,57,0.06)] z-50 rounded-t-[24px] md:hidden">
                <div className="flex flex-col items-center justify-center text-blue-700 bg-blue-50 dark:bg-blue-900/30 rounded-2xl px-5 py-2 duration-300 ease-out transform scale-105">
                ...
                <div className="flex flex-col items-center justify-center text-slate-400 px-5 py-2 hover:text-blue-600 duration-300 ease-out transform active:scale-90">
                ...
                >
                    <span className="material-symbols-outlined mb-1">reviews</span>
