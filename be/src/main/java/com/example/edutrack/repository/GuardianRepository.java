...
public interface GuardianRepository extends JpaRepository<Guardian, UUID> {
    ...
    @Query(value = "SELECT * FROM guardians WHERE id = :id AND institution_id = :instId", nativeQuery = true)
    Optional<Guardian> findByIdNative(@Param("id") UUID id, @Param("instId") UUID instId);
}
