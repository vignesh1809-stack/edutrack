...
const StudentProfile = () => {
  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-6 pt-24 md:pt-12 pb-32 md:pb-12 md:pl-80 bg-surface min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-surface-container-lowest rounded-3xl p-8 shadow-[0px_20px_40px_rgba(42,52,57,0.04)]">
            <div className="flex justify-between items-center mb-8">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 rounded-xl text-sm font-bold hover:bg-blue-100 transition-colors active:scale-95">
            ...
            <div className="space-y-4">
              <div className="flex gap-4 p-4 rounded-2xl bg-surface-container-low/50 hover:bg-surface-container-low transition-colors group">
                <div className="w-12 h-12 rounded-full bg-slate-200 flex-shrink-0 flex items-center justify-center text-slate-500 font-bold border-2 border-white shadow-sm">DR</div>
                <div className="flex-grow">
                  <div className="flex justify-between items-center mb-1">
                    <h4 className="font-bold text-on-surface text-sm md:text-base">Dr. Sarah Richardson</h4>
                    <span className="text-[10px] font-bold text-slate-500 bg-white px-2 py-1 rounded shadow-sm border border-slate-100">Oct 24, 2023</span>
                  </div>
                  <p className="text-sm text-slate-600 leading-relaxed max-w-2xl mt-2">Alexander shows great potential in algorithm design but needs to focus more on documentation and peer review participation.</p>
                </div>
              </div>
              
              <div className="flex gap-4 p-4 rounded-2xl bg-error-container/5 hover:bg-error-container/10 transition-colors border border-error/10">
                <div className="w-12 h-12 rounded-full bg-error-container/20 flex-shrink-0 flex items-center justify-center text-error font-bold border-2 border-white shadow-sm">MP</div>
                <div className="flex-grow">
                  <div className="flex justify-between items-center mb-1">
                    <h4 className="font-bold text-on-surface text-sm md:text-base">Mark Peters <span className="font-medium text-slate-400 ml-1">(Attendance)</span></h4>
                    <span className="text-[10px] font-bold text-error bg-white px-2 py-1 rounded shadow-sm border border-error/10">Nov 12, 2023</span>
                  </div>
                  <p className="text-sm text-error leading-relaxed font-semibold max-w-2xl mt-2">Significant drop in attendance this month. Sent notice to guardian via registered email.</p>
                </div>
              </div>

              <div className="flex gap-4 p-4 rounded-2xl bg-surface-container-low/50 hover:bg-surface-container-low transition-colors">
                <div className="w-12 h-12 rounded-full bg-slate-200 flex-shrink-0 flex items-center justify-center text-slate-500 font-bold border-2 border-white shadow-sm">JH</div>
                <div className="flex-grow">
                  <div className="flex justify-between items-center mb-1">
                    <h4 className="font-bold text-on-surface text-sm md:text-base">Julian Hayes <span className="font-medium text-slate-400 ml-1">(Math)</span></h4>
                    <span className="text-[10px] font-bold text-slate-500 bg-white px-2 py-1 rounded shadow-sm border border-slate-100">Sep 30, 2023</span>
                  </div>
                  <p className="text-sm text-slate-600 leading-relaxed max-w-2xl mt-2">Exceptional performance in the mid-term calculus exam. Highest in class.</p>
                </div>
              </div>
            </div>
          </div>
